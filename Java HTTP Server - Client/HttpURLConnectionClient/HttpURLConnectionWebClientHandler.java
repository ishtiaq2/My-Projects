...
public class HttpURLConnectionWebClientHandler implements Runnable{
	...
	private static final String GET_URL = "http://localhost/?guess=5";
	private static final String POST_URL = "http://localhost";
	private static final String POST_PARAMS = "userName=ishtiaq";
	...
	public void showAverage() {
		...
		int avg = attempts / webClient.numberOfTimesPlayed;
