...
export class RestServiceService {
  ...
  private transactionSource = new BehaviorSubject<string[]>(defaultTransactions);
  transactionIds = this.transactionSource.asObservable();
...
const defaultTransactions: string[] = [];
